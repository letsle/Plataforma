...
import Logo from "../../assets/Logo.png";  // Importa o logotipo da empresa
import {
  Container,
  MainMenu,
  Menu,
     ...
     <>
       ...
       <Container changeBackground={changeBackground}>
         ...
         <MainMenu>
           ...
           <Li isActive={pathname.includes("/hospedagem")}>
             <Link to="/hospedagem">Hospedagem</Link>
           </Li>
           <Li isActive={pathname.includes("/email")}>
             <Link to="/email">E-mail</Link>
           </Li>
           <Li isActive={pathname.includes("/servidoresvps")}>
             <Link to="/servidoresvps">Servidores VPS</Link>
           </Li>
