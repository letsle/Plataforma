...
export const Container = styled.div`
  ...
  background-color: ${(props) =>
    props.changeBackground
      ? "#064d793a"
      : "#064D79"}; // Cor de fundo condicional com transição.
...
export const Li = styled.li`
  ...
  &::after {
    ...
    background-color: rgba(255, 255, 255, 0.8); // Cor da linha.
...
export const Menu = styled.div`
  ...
  button {
    ...
    &:hover {
      ...
      color: #f0003c; // Cor do texto ao passar o mouse.
...
export const CustomModal = styled.div`
  ...
  .input-container {
    input {
      ...
      &:focus {
        border: 2px solid #f0003c; /* Borda vermelha para o input selecionado */
      }
    }
  }
